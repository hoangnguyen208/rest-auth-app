package com.restphotoapp.restphotoapp.websecurity;
...
import com.restphotoapp.restphotoapp.SpringApplicationContext;
import com.restphotoapp.restphotoapp.models.DTO.UserDetailsResponse;
import com.restphotoapp.restphotoapp.models.DTO.UserLoginRequest;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            UserLoginRequest model = new ObjectMapper().readValue(req.getInputStream(), UserLoginRequest.class);
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain,
        ...
        UserDetailsResponse user = userService.getUser(username);
